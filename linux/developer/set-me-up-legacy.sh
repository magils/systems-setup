...
# NOTE: this script is intented for legacy systems, it does not full upgrade dependencies to avoid conflicts with legacy dependencies.
# USE ONLY for old systems.
